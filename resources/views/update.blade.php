...
<body>
    ...
    <main>
        <div class="container mt-4">
            ...
            <form class="row g-3" action="{{ route('update', ['id' => $producto->id]) }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="modelo" id="modelo" class="form-control" value="{{ $producto->modelo }}" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" name="activo" id="activo" class="form-control" value="{{ $producto->activo }}" required>
                </div>
                <div class="col-md-6">
                    <label for="kilometraje"><span class="text-danger"></span> Kilometraje</label>
                    <input type="number" name="kilometraje" id="kilometraje" class="form-control" value="{{ $producto->kilometraje }}" required>
                </div>
                <div class="col-md-6">
                    <label for="disponibilidad"><span class="text-danger"></span> Disponibilidad</label>
                    <input type="text" name="disponibilidad" id="disponibilidad" class="form-control" value="{{ $producto->disponibilidad }}" required>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-12">
                    <button type="submit" class="btn btn-primary" onclick="mostrarMensaje()">Editar</button>
                </div>
                <script>
                    function mostrarMensaje() {
                        // Mostrar mensaje de éxito
                        alert("Se edito el producto con éxito.");
                    }
                </script>
            </form>
        </div>
